...
abstract class Mage_ImportExport_Model_Abstract extends Varien_Object
{
    ...
    protected $_debugMode = true; // HARA MOD this wasnt used since dev
    ...
    public function addLogComment($debugData)
    {
        ...
        if (!$this->_logInstance) {
            ...
            $dirPath = Mage::getBaseDir('var') ./*Mage_ImportExport_Model_Scheduled_Operation::LOG_DIRECTORY*/ DS . 'log'. DS . 'import_export' . DS/*Here*/ // HARA MOD this wasnt used since dev//
                . $dirName;
            if (!is_dir($dirPath)) {
                mkdir($dirPath, 0777, true);
            }
            $fileName = substr(strstr(/*Mage_ImportExport_Model_Scheduled_Operation::LOG_DIRECTORY*/ (DS . 'log'. DS . 'import_export' . DS)/* HERE*/, DS), 1) // HARA MOD this wasnt used since dev Mage_ImportExport_Model_Scheduled_Operation::LOG_DIRECTORY
