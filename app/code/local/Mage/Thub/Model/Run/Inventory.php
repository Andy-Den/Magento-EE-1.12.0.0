...
//$this->Atribute_set_thub
    ...
    public Function AddOptions($flConfigurableProduct = false){
      ...
      // �������� ��������� ������� ������� �� $code
           ...
           /* start - <TIBB> 
		   echo ("Store id :".$this->storeId."<br>");
		   echo ("Name Options :".$_nameOption."<br>");
		   echo ("Entity Type id :".$this_entityTypeId."<br>");
           End - <TIBB> */	
		...
		//start - <TIBB>	
		$attribute = Mage::getModel('catalog/resource_eav_attribute')->load($attribute -> getId());
    	...
    	End - <TIBB> */		
		 ...
		 // var_dump($attribute);
		 // echo ("</pre>");
		 // echo(" "."Source model value : ".$attribute->getSourceModel()."<br>");
         // echo (""."Get Id :".$attribute->getId());
		 // End - <TIBB> */
		   ...
		   $attributeId = $attribute->getAttributeId();
            ...
            if ($attribute->usesSource()) {
               ...
               *///Code Not need    
    		   ...
    		   $optionCollection = $attribute->getSource()->getAllOptions(false);
...
/*         if(!$productIdParent = Mage::getModel('catalog/product')
      ...
      public  function  CheckCategory(){
         ...
         */
		 ...
		 $itemCategory = preg_replace('#//#','/',$itemCategory);
         $itemCategory = preg_replace('#^/#','',$itemCategory);
         $itemCategory = preg_replace('#/$#','',$itemCategory);
