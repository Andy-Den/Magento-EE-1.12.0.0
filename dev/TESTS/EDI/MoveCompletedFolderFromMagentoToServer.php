...
$testFunction->setTestName('Moves all files from Magento In>Completed Folder to Server In>Completed Folder');
$testFunction->outputStartMsg();

$params = Mage::app()->getRequest()->getParams();
if (true) {
    $testFunction->outputControlMessage('Moves all files from Magento In>Completed Folder to Server In>Completed Folder.');
...
// Set From => TO
$fromDir = realpath($mageBaseDirectory . DS . 'in' . DS . 'complete' . DS);
$toDir = $smEdiBase . DS . 'in' . DS . 'complete' . DS;
